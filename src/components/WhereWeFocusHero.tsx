        ...
        <section className="relative h-[60vh] md:h-[65vh] w-full overflow-hidden flex items-center justify-center bg-[var(--brand-black)]">
            ...
            <div className="container relative z-30 text-center px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        Where We <span className="text-[var(--primary-blue)]">Focus</span>
                    </motion.h1>
                    ...
                    >
                        Our focus areas reflect where evidence, advocacy, and collaboration can drive meaningful and lasting change in water systems.
                    </motion.p>
