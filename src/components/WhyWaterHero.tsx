        ...
        <section className="relative h-[60vh] md:h-[65vh] w-full overflow-hidden flex items-center justify-center bg-[var(--brand-black)]">
            ...
            <div className="container relative z-30 text-center px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        Why <span className="text-[var(--primary-blue)]">Water</span>
                    </motion.h1>
                    ...
                    >
                        Water underpins almost every dimension of human development — yet it remains one of the most unequally accessed resources globally.
                    </motion.p>
