        ...
        <section className="relative h-[60vh] md:h-[65vh] w-full overflow-hidden flex items-center justify-center bg-[var(--brand-black)]">
            ...
            <div className="container relative z-30 text-center px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        Take <span className="text-[var(--primary-blue)]">Action</span>
                    </motion.h1>
                    ...
                    >
                        Improving water outcomes requires collective effort. We provide pathways to collaborate, share knowledge, and support evidence-based action.
                    </motion.p>
