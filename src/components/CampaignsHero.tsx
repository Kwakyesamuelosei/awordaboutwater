        ...
        <section className="relative h-[60vh] md:h-[65vh] w-full overflow-hidden flex items-center justify-center bg-[var(--brand-black)]">
            ...
            <div className="container relative z-30 text-center px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        Our <span className="text-[var(--primary-blue)]">Campaigns</span>
                    </motion.h1>
                    ...
                    >
                        A Word About Water advances focused initiatives that connect research, dialogue, and applied learning to strengthen global water systems.
                    </motion.p>
